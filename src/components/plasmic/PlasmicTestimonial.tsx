    ...
    import Avatar from "..//Avatar";  // plasmic-import: 0Ji4ThxiGlwdl/component
    
    
    import "@plasmicapp/react-web/lib/plasmic.css";
    import  "./plasmic__default_style.css"; // plasmic-import: global/defaultcss
    import  "./plasmic_final_not_exported.css"; // plasmic-import: cB98qoa8i3odyeQmSRqxXv/projectcss
    import  "./PlasmicTestimonial.css" // plasmic-import: nypwqsR2bkNRn/css
  
    import QuoteDashesIcon from "./PlasmicIcon__QuoteDashes";  // plasmic-import: OwyyGkfswVO63/icon
...
svg?: p.Flex<"svg">;
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "root_reset_cB98qoa8i3odyeQmSRqxXv", "Testimonial__root___5JBq")}
  ...
  <Avatar
    ...
    className={classNames("__wab_instance", "Testimonial__avatar__uVczk")}
pic={
  <img
    ...
    alt={""}
className={classNames("plasmic_default__all", "plasmic_default__img", "Testimonial__img__qun0S")}
role={"img"}
src={"Plasmic_Image_VzNGPO9M8sAca__Ref"}
  ...
  <QuoteDashesIcon
    ...
    className={classNames("plasmic_default__all", "plasmic_default__svg", "Testimonial__svg__mrWnf")}
role={"img"}
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "Testimonial__box__mdjiR")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Testimonial__box__cHxts")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Testimonial__box__rfvUz")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "__wab_text", "Testimonial__box__ty3Sc")}
