    ...
    import  "./PlasmicBullet.css" // plasmic-import: W62hJLXSC_eY3/css
  
    import Done24Pxsvg2Icon from "./PlasmicIcon__Done24Pxsvg2";  // plasmic-import: wlmNziuq72yBc/icon
...
svg?: p.Flex<"svg">;
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "root_reset_cB98qoa8i3odyeQmSRqxXv", "Bullet__root___2LRyc")}
  ...
  <Done24Pxsvg2Icon
    ...
    className={classNames("plasmic_default__all", "plasmic_default__svg", "Bullet__svg__tfHAl")}
role={"img"}
