    ...
    import  "./PlasmicFaq.css" // plasmic-import: bL96zrCYJHfc7/css
...
slot?: React.ReactNode
  ...
  <BaseCard
    ...
    className={classNames("__wab_instance", "Faq__root__bQdD3")}
  ...
  <p.Stack
    ...
    hasGap={true}
    className={classNames("plasmic_default__all", "plasmic_default__div", "Faq__box__wHcKq")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "Faq__box__cgzsy")}
  ...
  <div
    ...
    className={classNames("plasmic_default__all", "plasmic_default__div", "Faq__box__nT1QC")}
    
    >
          <p.PlasmicSlot
      defaultContents={"Are there long-term contracts?"}
      value={args.children}
      className={classNames("Faq__slotChildren___7ZYqb")} />
        </div>
...
<p.PlasmicSlot
      ...
      value={args.slot}
      className={classNames("Faq__slotSlot__d3Z8Y")} />
        </p.Stack>
