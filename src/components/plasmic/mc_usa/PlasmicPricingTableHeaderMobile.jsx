...
import * as sty from "./PlasmicPricingTableHeaderMobile.module.css"; // plasmic-import: zCyM3n60XUg/css

export const PlasmicPricingTableHeaderMobile__VariantProps = new Array();

export const PlasmicPricingTableHeaderMobile__ArgProps = new Array();

function PlasmicPricingTableHeaderMobile__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicPricingTableHeaderMobile__ArgProps,
      internalVariantPropNames: PlasmicPricingTableHeaderMobile__VariantProps
    });

    return PlasmicPricingTableHeaderMobile__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPricingTableHeaderMobile";
  } else {
    func.displayName = `PlasmicPricingTableHeaderMobile.${nodeName}`;
  }
  return func;
}

export const PlasmicPricingTableHeaderMobile = Object.assign(
  // Top-level PlasmicPricingTableHeaderMobile renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicPricingTableHeaderMobile
    internalVariantProps: PlasmicPricingTableHeaderMobile__VariantProps,
    internalArgProps: PlasmicPricingTableHeaderMobile__ArgProps
  }
);

export default PlasmicPricingTableHeaderMobile;
/* prettier-ignore-end */
