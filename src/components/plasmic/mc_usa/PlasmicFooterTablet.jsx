...
import * as sty from "./PlasmicFooterTablet.module.css"; // plasmic-import: suCoex1ZEws/css

export const PlasmicFooterTablet__VariantProps = new Array();

export const PlasmicFooterTablet__ArgProps = new Array();

function PlasmicFooterTablet__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
  const func = function (props) {
    const { variants, args, overrides } = deriveRenderOpts(props, {
      ...
      internalArgPropNames: PlasmicFooterTablet__ArgProps,
      internalVariantPropNames: PlasmicFooterTablet__VariantProps
    });

    return PlasmicFooterTablet__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicFooterTablet";
  } else {
    func.displayName = `PlasmicFooterTablet.${nodeName}`;
  }
  return func;
}

export const PlasmicFooterTablet = Object.assign(
  // Top-level PlasmicFooterTablet renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicFooterTablet
    internalVariantProps: PlasmicFooterTablet__VariantProps,
    internalArgProps: PlasmicFooterTablet__ArgProps
  }
);

export default PlasmicFooterTablet;
/* prettier-ignore-end */
