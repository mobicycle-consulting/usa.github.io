...
import { CheckIcon, MinusIcon, ChevronDownIcon } from '@heroicons/react/solid';
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:flex lg:justify-between">
          <div className="max-w-xl">
            ...
            <h4 className="mt-5 text-3xl font-extrabold text-yellow-200 sm:text-3xl sm:tracking-tight lg:text-3xl">
                This pages is currently under construction. Please check back soon!
            </h4>
