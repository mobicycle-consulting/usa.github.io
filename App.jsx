...
import MacBookPro1440 from "./components/MacBookPro1440";
  ...
  return (
    <Router>
      <Switch>
        ...
        <Route path="/macbook-pro-1440">
          <MacBookPro1440 {...MacBookPro1440Data} />
        </Route>
...
const MacBookPro1440Data = {
    ...
    overlapGroup4: "/img/rectangle-19@1x.svg",
    pricing: "PRICING",
...
const IMac1280Data = {
    ...
    overlapGroup3: "/img/rectangle-21@1x.svg",
    pricing: "PRICING",
    featureBy: "Feature by",
    plans: "Plans",
    basic: "Basic",
...
const SurfaceBook1500Data = {
    ...
    overlapGroup3: "/img/rectangle-14@1x.svg",
    pricing: "PRICING",
    featureBy: "Feature by",
    plans: "Plans",
    basic: "Basic",
    ...
    sharedDotPattern2: "/img/shared-dot-pattern-3@1x.png",
